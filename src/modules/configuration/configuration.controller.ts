...
export class ConfigurationController {
  ...
  @ApiResponse({ status: 200, description: 'List of invoice types retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'List of payment means retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'List of tax categories retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'List of currencies retrieved successfully' })
  async getCurrencies() {
  ...
  @ApiResponse({ status: 200, description: 'List of VAT exemptions retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'List of product codes retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'List of service codes retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'List of local government areas retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'List of state codes retrieved successfully' })
  async getStateCodes() {
  ...
  async smokeTest() {
    return { message: 'Configuration service is working', timestamp: new Date().toISOString() };
  }
} 